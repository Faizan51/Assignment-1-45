...
let listOfThings:string[]=["K2","River Indus","Karachi","Urdu","Circket"];
let wantToSearch:string[]=["Karachi"]
...
let listOfThings1:string[]=["K2","River Indus","Karachi","Urdu","Circket"];
let wantToSearch1:string[]=["Karachi"]
for (let i=0;i<listOfThings1.length;i++){
    if (wantToSearch1[0]===listOfThings1[i])
        console.log(`Item is in the list and its index is ${[i]}`)
    else (console.log('Item is not present in the array'))
}